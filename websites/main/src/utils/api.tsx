...
export default {
  ...
  game: {
    ...
    getGamesList: (offset = 0) =>
      axios.get(API_BASE_URL + "/game/match/latest/?offset=" + offset)
        .then((response) => response.data),
    ...
    getUserGames: (userId, offset) =>
      axios.get(API_BASE_URL + "/game/user/" + userId + "/matches/?offset=" + offset)
        .then((response) => response.data),
    ...
    getUserChallenges: (userId, offset) =>
      axios.get(API_BASE_URL + "/game/user/" + userId + "/challenges/?offset=" + offset)
        .then((response) => response.data),
